...
router.patch("/:orgId/board/:boardId/task/:cardId/take", authMiddleware, CardController.takeTask);
router.patch("/:orgId/board/:boardId/task/:cardId/status", authMiddleware, CardController.updateTaskStatus);
