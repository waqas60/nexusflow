...
export default function AddCard(addCardData: AddCardProp) {
  return (
    <div className="absolute right-2 left-2 sm:left-auto sm:right-10 bg-sky-200 p-4 sm:p-5 rounded-2xl z-10 flex flex-col gap-4 w-auto sm:w-96">
      <Input
        type="text"
      ...
      <textarea
        ...
        className="resize-none outline-none p-2 h-32 sm:h-40 bg-white rounded-md w-full placeholder:text-sm text-sm"
      />

      <select
        ref={addCardData.difficultyRef}
        className="w-full px-3 py-2 rounded-lg border border-gray-200 text-sm text-gray-600 bg-white"
      >
